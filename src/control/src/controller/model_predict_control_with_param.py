...
NX = config_variable['NX']  # x = x, y, v, yaw
NU = config_variable['NU']  # a = [accel, steer]
T = config_variable['T']  # horizon length

# mpc parameters
R = config_variable['R']  # input cost matrix
Rd = config_variable['Rd']  # input difference cost matrix
Q = config_variable['Q']  # state cost matrix
Qf = config_variable['Q']  # state final matrix

GOAL_DIS = config_variable['GOAL_DIS']  # goal distance
STOP_SPEED = config_variable['STOP_SPEED']  # stop speed
MAX_TIME = config_variable['MAX_TIME']  # max simulation time

# iterative parameter
MAX_ITER = config_variable['MAX_ITER']  # Max iteration
DU_TH = config_variable['DU_TH']  # iteration finish param

TARGET_SPEED = config_variable['TARGET_SPEED']  # [m/s] target speed
N_IND_SEARCH = config_variable['N_IND_SEARCH']  # Search index number

DT = config_variable['DT']  # [s] time tick

# Vehicle parameters
LENGTH = config_variable['LENGTH']  # [m]
WIDTH = config_variable['WIDTH']  # [m]
BACKTOWHEEL = config_variable['BACKTOWHEEL']  # [m]
WHEEL_LEN = config_variable['WHEEL_LEN']  # [m]
WHEEL_WIDTH = config_variable['WHEEL_WIDTH']  # [m]
TREAD = config_variable['TREAD']  # [m]
WB = config_variable['WB']  # [m]

MAX_STEER = config_variable['MAX_STEER']  # maximum steering angle [rad]
MAX_DSTEER = config_variable['MAX_DSTEER']  # maximum steering speed [rad/s]
MAX_SPEED = config_variable['MAX_SPEED']  # maximum speed [m/s]
MIN_SPEED = config_variable['MIN_SPEED']  # minimum speed [m/s]
MAX_ACCEL = config_variable['MAX_ACCEL']  # maximum accel [m/ss]
