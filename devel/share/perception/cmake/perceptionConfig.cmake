...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /workspace/src/perception)
  set(perception_DEVEL_PREFIX /workspace/devel)
  ...
  set(perception_INSTALL_PREFIX /workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/perception/${idir}'.  ${_report}")
    endif()
